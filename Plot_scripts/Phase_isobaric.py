...
for wdir in [wd.wdir30,wd.wdir31,wd.wdir32]:
    ...
    ax1[0,count].set_ylim(0.0605,0.0635)
    ...
    ax1[1,count].set_ylim(0.0605,0.0635)
    ax2.set_ylim(-0.0002,0.0002)
    ax2.set_title(r'With $\Delta\phi = '+phi_arr[count]+'$ at t=400 Myr',fontsize=20)
    
    count +=1
    
plt.savefig(wdir_script+'/Phase_isobaric.png')