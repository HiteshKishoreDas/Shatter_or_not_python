...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 15 13:13:08 2020
...
wdir_isobaric = wd.wdir18
wdir_isochoric = wd.wdir37
...
plt.plot(t_arr,lt_isochoric,color='b',linestyle='--',linewidth=width+1,label=r"Linear theory: Isochoric k=$0.01\pi$")
plt.plot(t_arr,sim_isochoric,color='r',linestyle='--',linewidth=width,label=r"Simulation: Isochoric k=$0.01\pi$")
...
plt.savefig(wdir_script+'/rho_linear_noch.png')